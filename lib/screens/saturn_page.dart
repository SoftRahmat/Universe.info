...
class SaturnPage extends StatefulWidget {
  static const String id = 'saturn_page';
  @override
...
class SaturnComponents extends StatefulWidget {
  @override
  _SaturnComponentsState createState() => _SaturnComponentsState();
}

class _SaturnComponentsState extends State<SaturnComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/saturnmain.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
                  ...
                  Row(
                    children: <Widget>[
                      PageButton1(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, SeturnDetailse.id);
                        },
                      ),
                    ],
                  ),
