...
class UranusPage extends StatefulWidget {
  static const String id = 'uranus_page';
  @override
...
class UranusComponents extends StatefulWidget {
  @override
  _UranusComponentsState createState() => _UranusComponentsState();
}

class _UranusComponentsState extends State<UranusComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/uranus.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
                  ...
                  Row(
                    children: <Widget>[
                      PageButton1(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, UranusDetailse.id);
                        },
                      ),
                    ],
                  ),
