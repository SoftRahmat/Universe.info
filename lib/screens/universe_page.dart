...
class PlanetsPage extends StatefulWidget {
  static const String id = 'universe_page';
  @override
...
class PlanetsComponents extends StatefulWidget {
  @override
  _PlanetsComponentsState createState() => _PlanetsComponentsState();
}

class _PlanetsComponentsState extends State<PlanetsComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/universeScale.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
