...
class MoonPage extends StatefulWidget {
  static const String id = 'moon_page';
  @override
...
class MoonComponents extends StatefulWidget {
  @override
  _MoonComponentsState createState() => _MoonComponentsState();
}

class _MoonComponentsState extends State<MoonComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/moon.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
                  ...
                  Row(
                    children: <Widget>[
                      PageButton1(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, MoonDetailse.id);
                        },
                      ),
                    ],
                  ),
