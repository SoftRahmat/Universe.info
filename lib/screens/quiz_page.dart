...
class QuizComponents extends StatefulWidget {
  @override
  _QuizComponentsState createState() => _QuizComponentsState();
}

class _QuizComponentsState extends State<QuizComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
                    ...
                    Row(
                      children: <Widget>[
                        PageButton1(
                          ...
                          onPressed: () {
                            Navigator.pushNamed(context, QuizBar.id);
                          },
                        ),
                      ],
                    ),
