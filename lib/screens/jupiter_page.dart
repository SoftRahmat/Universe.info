...
class JupiterPage extends StatefulWidget {
  static const String id = 'jupiter_page';
  @override
...
class JupiterPageComponents extends StatefulWidget {
  @override
  _JupiterPageComponentsState createState() => _JupiterPageComponentsState();
}

class _JupiterPageComponentsState extends State<JupiterPageComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/jupiter.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
                  ...
                  Row(
                    children: <Widget>[
                      PageButton1(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, JupiDetailse.id);
                        },
                      ),
                    ],
                  ),
