...
class MercuryPage extends StatefulWidget {
  static const String id = 'mercury_page';
  @override
...
class MercuryComponents extends StatefulWidget {
  @override
  _MercuryComponentsState createState() => _MercuryComponentsState();
}

class _MercuryComponentsState extends State<MercuryComponents> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/MERCURY.gif'),
          fit: BoxFit.fill,
        ),
      ),
      child: SafeArea(
                  ...
                  Row(
                    children: <Widget>[
                      PageButton1(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, MercuryDetailse.id);
                        },
                      ),
                    ],
                  ),
